...
class TextParser:
    ...
    def parse(self):
        ...
        for index, element in enumerate(blocks):
            ...
            pgn = self._find_value(Patterns.BLOCK_DATA_PGN, block_text)
    ...
    def _find_detail_param_info(self, param_name: str, param_paragraph: str):
        ...
        param_detail_info["slot_scaling"] = self._find_value(
            Patterns.PARAM_DETAIL_SLOT_SCALING, param_info_block_text
        ).strip()
        param_detail_info["slot_range"] = self._find_value(Patterns.PARAM_DETAIL_SLOT_RANGE, param_info_block_text)
    ...
    def _find_value(pattern: str, text: str, group_name: str = ""):
        ...
        return match.group(1) if match.groups() else match
